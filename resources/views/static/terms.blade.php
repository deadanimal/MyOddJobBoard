...
@section('content')
    ...
    <div class="bg-white px-6 py-32 lg:px-8">
        <div class="mx-auto max-w-3xl text-base leading-7 text-gray-700">
            ...
            <div class="mt-16 max-w-2xl">
                <p class="mt-6">At My Odd Job Board, accessible from https://stars.my, one of our main priorities is the privacy of
                    our visitors. This Privacy Policy document contains types of information that is collected and recorded
                    by My Odd Job Board and how we use it.</p>
                ...
                <p class="mt-6">This Privacy Policy applies only to our online activities and is valid for visitors to our
                    website with regards to the information that they shared and/or collect in My Odd Job Board. This policy is not
    ...
    <p>My Odd Job Board follows a standard procedure of using log files. These files log visitors when they visit websites. All
    ...
    <p>Like any other website, My Odd Job Board uses "cookies". These cookies are used to store information including visitors'
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of My Odd Job Board.</p>
    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on My Odd Job Board, which are sent directly to users' browser. They
    ...
    <p>Note that My Odd Job Board has no access to or control over these cookies that are used by third-party advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>My Odd Job Board's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
    ...
    <p>My Odd Job Board does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
